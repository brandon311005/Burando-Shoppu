 ...
 */
public class FrameListeProduit extends javax.swing.JFrame {
    ...
    public FrameListeProduit() {
        ...
        tableau.addColumn("Id Catégorie");
        ...
        try {
            ...
            try{
                ...
                while (rst.next()){
                    ...
                    tableau.addRow(new Object[]{rst.getString("IdProduit"),rst.getString("NomProduit"),rst.getString("PrixUn"),rst.getString("StockDispo"),rst.getString("IdCategorie")});
